var Environment = Backbone.Model.extend({
  ...
  markeSetzen: function() {
    ...
    this.trigger('change-field', this.get('position'));
  },
  ...
  istNorden: function() {
    return this.direction.equals(Position.NORTH);
  },

  istSueden: function() {
    return this.direction.equals(Position.SOUTH);
  },

  istWesten: function() {
    return this.direction.equals(Position.WEST);
  },

  istOsten: function() {
    return this.direction.equals(Position.EAST);
  },
