...
Karel.Views.World3D = Karel.Views.WorldBase.extend(!Skin.hasCanvasSupport ? {} : {
  ...
  initialize: function() {
    _(this).bindAll(
      ...
      'onResize', 'render', 'delayRender', 'removeScrollEvents', 'delegateEvents'
    )
    ...
    this
      .bind('insert', this.render)
      .bind('insert', this.delegateEvents)
    ...
    this.bind('remove', this.removeScrollEvents)
  },
