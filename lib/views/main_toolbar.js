Karel.Views.MainToolbar = Skin.Toolbar.extend({
  ...
  initialize: function() {
    ...
    var self = this
    this.add(Skin.button("Run",    function() { self.model.run() }))
    this.add(Skin.button("Replay", function() { self.model.replay() }))
    this.add(Skin.button("Reset",  function() { self.model.reset() }))
    this.add(Skin.button("Save",   function() { self.model.save() }))
