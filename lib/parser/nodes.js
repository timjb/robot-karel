...
n.ConditionDefinition = extendNode(function (id, formalParameters, block) {
  this.identifier       = id
  this.formalParameters = formalParameters
  this.block            = block
})

n.FunctionDefinition = extendNode(function (id, formalParameters, block) {
  this.identifier       = id
  this.formalParameters = formalParameters
  this.block            = block
})
...
n.FormalParameters = extendNode(function (identifier) {
  this.identifier = identifier
})

n.Parameters = extendNode(function (argument) {
