...
exports.eval = function (code, globals) {
  console.log(parser.parse(code.toLowerCase()))
...
n.Block.prototype.eval = function (env) {
  ...
  for (var i = 0, l = statements.length; i < l; i++) {
    ...
    ,   isDefinition = statement instanceof n.FunctionDefinition
                    || statement instanceof n.ConditionDefinition
...
n.ConditionDefinition.prototype.eval = function (topEnv) {
  log("ConditionDefinition")
  var definition = this
  env[this.identifier.name] = { apply: function (_rcvr, parameters) {
...
n.FunctionDefinition.prototype.eval = function (topEnv) {
