...
n.Definition.prototype.render = function () {
  var header = this.isCondition ? "Bedingung" : "Anweisung"
  return '<h4>'+header+' <strong>'+this.identifier.render()+'</strong></h4>'
       + this.block.render()
}
...
n.For.prototype.render = function () {
  return "wiederhole " + this.times.render() + " mal"
       + '<div class="loop-body">' + this.block.render() + '</div>'
}

n.Number.prototype.render = function () {
