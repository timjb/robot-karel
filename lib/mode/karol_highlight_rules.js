...
var KarolHighlightRules = function() {
    ...
    var commands = lang.arrayToMap(
        _(("probiere|schritt|schrittRückwaerts|linksDrehen|rechtsDrehen|tonErzeugen|hinlegen|aufheben|" +
        "markeSetzen|markeUmschalten|markeLöschen|quaderAufstellen|quaderEntfernen").split("|")).map(function(a) {
